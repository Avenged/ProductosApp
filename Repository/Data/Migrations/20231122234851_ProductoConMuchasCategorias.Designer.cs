...
namespace ProductosApp.Data.Migrations
{
    ...
    [Migration("20231122234851_ProductoConMuchasCategorias")]
    partial class ProductoConMuchasCategorias
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.ProductoCategorias", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Domain.ProductoCategorias", b =>
                {
                    b.HasOne("ProductosApp.Data.Categoria", "Categoria")
                        .WithMany()
                        .HasForeignKey("CategoriaId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ProductosApp.Data.Producto", "Producto")
                        .WithMany("Categorias")
